...
/***/ function(module, exports, __webpack_require__) {
	...
	var isTimeStamp = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../src/isTimeStamp.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var App = function (_Component) {
	  ...
	  function App() {
	    ...
	    _this.state = { input: undefined, output: "" };
	    return _this;
	  }

	  _createClass(App, [{
	    key: 'printToScreen',
	    value: function printToScreen(json) {
	      //Check that input was valid
	      if (json.natural === null) {
	        //Print error message
	        var errorMsg = "Please enter valid timestamp or date (p.s. don't forget to add a comma in your dates)";
	      ...
	      //If input is a timestamp, return number
	          ...
	          this.setState({ output: json.unix });
	        }
	    }
	  }, {
	    key: 'handleSubmit',
	    value: function handleSubmit() {
	      ...
	      //Create correct url
	      var url = "https://dry-river-67944.herokuapp.com/" + this.state.input;
	      fetch(url).then(function (response) {
	        return response.json();
	      }).then(function (json) {
	        return _this2.printToScreen(json);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'text', onChange: function onChange(event) {
	            return _this3.setState({ input: event.target.value });
	          } }),
	        ' ',
